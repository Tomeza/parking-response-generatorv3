-- Initial RLS policies for production security
-- 2025-08-09: Complete RLS setup for secure production deployment
...
-- 3. Create RLS policy for Templates (approved only)
...
-- 4. Enable and force RLS on all tables
...
-- 6. Create index for status filtering (performance optimization)
